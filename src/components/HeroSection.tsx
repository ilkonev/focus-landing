  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen flex items-center overflow-hidden pt-16 md:pt-20 pb-8 bg-background">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-[200px] h-[200px] sm:w-[300px] sm:h-[300px] lg:w-[400px] lg:h-[400px] bg-primary/3 rounded-full blur-3xl animate-float-slow" />
      </div>

      <div className="section-container relative z-10 py-8 md:py-12 lg:py-20">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          {/* Left: Content */}
          <div className="space-y-8 text-center lg:text-left">
            <div className="space-y-6">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold leading-[1.1] animate-fade-in-up tracking-tight">
                <span className="text-foreground">Время под контролем</span>
                <br />
                <span className="text-gradient">внимание в фокусе</span>
              </h1>
              
              <p className="text-base sm:text-lg lg:text-xl text-muted-foreground max-w-xl mx-auto lg:mx-0 animate-fade-in-up-delay-1 leading-relaxed">
